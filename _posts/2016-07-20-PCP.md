...
![Realization of an homogeneous PPP](group-web/assets/images/pcp_post1/ppp.jpg){:width="300px" .align-center}<center>Realization of an homogeneous PPP.</center>
...
![Realization of an homogeneous PPP](group-web/assets/images/pcp_post1/pcp.png){:width="300px" .align-center}<center>Realization of a PCP.</center>
